...
$sql="insert into user(name,surname,mail,phone,location,articles,deliveryFee,withdrawalFee,total) values('$name','$surname','$mail','$phone','$delivery','$articles','$transFee','$wdFee','$total')";
